  ...
  private async handlePropertyEvaluation(params: {
    ...
    try {
      ...
      const DISTRICT_AR: Record<string, string> = {
        ...
        'qassaa': 'القصاع', 'qassa': 'القصاع', 'baramkeh': 'البرامكة',
        ...
        'dummar': 'دمر', 'qudsaya': 'قدسيا', 'zabadani': 'الزبداني',
        ...
        'sarouja': 'ساروجة', 'qanawat': 'القنوات',
        'shaghour': 'الشاغور', 'amara': 'العمارة',
        'hajar aswad': 'حجر الأسود', 'hajar_aswad': 'حجر الأسود',
        'qaymariyya': 'القيمرية', 'salihiyya': 'الصالحية',
        'muhajirin': 'المهاجرين', 'dahdah': 'الدحداح',
        'hameh': 'حمة', 'muadamiyya': 'المعضمية',
        'quneitra': 'القنيطرة', 'habboubi': 'الحبوبي',
        'rabweh': 'الربوة',
      };
