...
const USER_DEFINITIONS = [
  ...
  { email: 'agent1.urbanex@example.com', fullName: 'يوسف النجار', role: Role.ADMIN, phone: '+963938411118' },
  { email: 'agent2.urbanex@example.com', fullName: 'مروان القادري', role: Role.ADMIN, phone: '+963938411119' },
